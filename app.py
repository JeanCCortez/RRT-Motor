...
LANG = {
    ...
    "EN": {
        ...
        "rep_opt_text": "TECHNICAL REPORT:\nVisible mass deflects light by only {tbar:.2f} arcsec. RRT applies Time Refraction (eta_C = {etac:.5f}). Phase delay widens the ring to {ttrr:.2f} arcsec, matching the telescope. Accuracy: {prec:.2f}%.",
        "rep_red_text": "PREDICTIVE REPORT:\n1. CHALLENGE: Lens mass ({mest_obs}x10^11) generates minimal classical curvature. The Standard Model would require massive halos.\n2. RRT CONVERGENCE: Sweeping cosmic fabric based on Beta refraction, the algorithm mathematically predicts the source galaxy is at z_S = {zs_pred:.4f} to form the {tobs} arcsec ring.\nRESULT: Cross-calibration accuracy of {prec:.2f}%.",
        "rep_str_text": "HYDRODYNAMICS REPORT:\n1. Classical astrophysics claims stream 'gaps' are invisible collisions.\n2. RRT tracked the orbit measuring tidal forces. Viscous Shear hit critical rupture limits exactly at {loc_str}. The gap is vacuum fluid friction."
    },
    "ES": {
